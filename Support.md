...
- Make sure the ingredient label is well lit and in focus.
- Retake the photo if the label is curved, blurry, or partially hidden.
- Review parsed ingredients before relying on the result.
- If camera or photo access is not working, check iOS Settings > BanScan.
